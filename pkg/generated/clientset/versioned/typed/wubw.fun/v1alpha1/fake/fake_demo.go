...
type FakeDemos struct {
	Fake *FakeWubwV1alpha1
	ns   string
}

var demosResource = schema.GroupVersionResource{Group: "wubw.fun", Version: "v1alpha1", Resource: "demos"}

var demosKind = schema.GroupVersionKind{Group: "wubw.fun", Version: "v1alpha1", Kind: "Demo"}
